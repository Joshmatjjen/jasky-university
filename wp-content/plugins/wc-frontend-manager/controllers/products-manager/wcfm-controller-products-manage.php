	  	...
	  	// Creating new product
			...
			if(!is_wp_error($new_product_id)) {
				...
				$wcfm_product_data_factory = apply_filters( 'wcfm_product_data_factory', array(
																										...
																										'date_on_sale_from'  => isset( $wcfm_products_manage_form_data['sale_date_from'] ) ? wc_clean( $wcfm_products_manage_form_data['sale_date_from'] ) : '',
																										'date_on_sale_to'    => isset( $wcfm_products_manage_form_data['sale_date_upto'] ) ? wc_clean( $wcfm_products_manage_form_data['sale_date_upto'] ) : '',
