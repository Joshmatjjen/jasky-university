...
class WCFM_Admin {
	...
	public function wcfm_wcfmu_inactive_notice() {
		...
		$offer_msg .= __( '<p>WooCommerce Frontend Manage - Ultimate is there to fill up all those for you. Support Ticket, Shipment Tracking, Direct Messaging, Vendor Followers, Product Importer, Custom Attriutes and many more, almost a never ending features list for you.</p>', 'wc-frontend-manager' );
		?>
