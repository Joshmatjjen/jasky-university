...
class WCFM_Dashboard_Setup {
			...
			<form method="post">
				<table class="form-table">
					...
					$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_marketplace_settings_fields_store', array(
																																											...
																																											"vendor_sold_by" => array('label' => __('Visible Sold By', 'wc-multivendor-marketplace'), 'type' => 'checkboxoffon', 'in_table' => 'yes', 'class' => 'wcfm-checkbox input-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title', 'value' => 'yes', 'dfvalue' => $vendor_sold_by ),
	...
	public function wcfm_setup_withdrawal() {
		...
		$withdrawal_percent_charge = isset( $wcfm_withdrawal_options['withdrawal_percent_charge'] ) ? $wcfm_withdrawal_options['withdrawal_percent_charge'] : '';
		$withdrawal_fixed_charge = isset( $wcfm_withdrawal_options['withdrawal_fixed_charge'] ) ? $wcfm_withdrawal_options['withdrawal_fixed_charge'] : '';
		?>
			...
			<table class="form-table">	
			  <?php
					$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_marketplace_settings_fields_withdrawal_limits', array(																																				
																																									...
																																									"withdrawal_percent_charge" => array('label' => __('Percent Charge(%)', 'wc-multivendor-marketplace'), 'name' => 'wcfm_withdrawal_options[withdrawal_percent_charge]', 'type' => 'number', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele withdraw_charge_field withdraw_charge_percent withdraw_charge_percent_fixed', 'label_class' => 'wcfm_title wcfm_ele withdraw_charge_field withdraw_charge_percent withdraw_charge_percent_fixed', 'value' => $withdrawal_percent_charge , 'attributes' => array( 'min' => '0.1', 'step' => '0.1') ),
																																									"withdrawal_fixed_charge" => array('label' => __('Fixed Charge', 'wc-multivendor-marketplace'), 'name' => 'wcfm_withdrawal_options[withdrawal_fixed_charge]', 'type' => 'number', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele withdraw_charge_field withdraw_charge_fixed withdraw_charge_percent_fixed', 'label_class' => 'wcfm_title wcfm_ele withdraw_charge_field withdraw_charge_fixed withdraw_charge_percent_fixed', 'value' => $withdrawal_fixed_charge , 'attributes' => array( 'min' => '0.1', 'step' => '0.1') ),
																																									) ) );
				?>
			</table>
			<p class="wc-setup-actions step">
