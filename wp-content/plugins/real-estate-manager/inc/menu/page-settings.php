	...
	<div class="row">
			...
			<div class="list-group wcp-tabs-menu">
				<?php $all_fields_settings = $this->admin_settings_fields();
					foreach ($all_fields_settings as $panel) { ?>
						<a href="#<?php echo rem_string_into_id($panel['panel_title']); ?>" role="button" class="list-group-item">
		...
		<div class="col-sm-9">
			<form id="rem-settings-form" class="form-horizontal">
				...
				<?php $all_fields_settings = $this->admin_settings_fields();
					foreach ($all_fields_settings as $panel) { ?>
						<div class="panel panel-default" id="<?php echo rem_string_into_id($panel['panel_title']); ?>">
